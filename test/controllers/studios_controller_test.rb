...
class StudiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create studio" do
    assert_difference('Studio.count') do
      post studios_url, params: { studio: { addr1: @studio.addr1, addr2: @studio.addr2, name: @studio.name, phone: @studio.phone } }
    end
  ...
  test "should update studio" do
    patch studio_url(@studio), params: { studio: { addr1: @studio.addr1, addr2: @studio.addr2, name: @studio.name, phone: @studio.phone } }
